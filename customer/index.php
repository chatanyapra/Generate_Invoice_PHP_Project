            ...
            <div class="p-4 sm:p-6 lg:p-8">
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                    <div>
                        ...
                        <p class="text-slate-500 mt-1">Manage your customer database for invoicing.</p>
                    </div>
                    <button id="add-customer-btn"
                        class="mt-4 sm:mt-0 flex items-center justify-center bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg shadow-sm hover:bg-blue-700 transition-colors duration-200">
                ...
                <div class="mt-8 bg-white rounded-lg shadow-sm border border-slate-200 p-6">
                    <h3 class="text-lg font-semibold text-slate-800">Search Customers</h3>
                    <div class="relative mt-4">
                        <input type="text" placeholder="Search by name, GSTIN, or state..."
                            class="form-input w-full rounded-md border-slate-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm pr-16">
                        <button
                            class="absolute inset-y-0 right-0 flex items-center pr-3 text-sm font-medium text-slate-500 hover:text-slate-700">
                ...
                <div class="mt-8 bg-white rounded-lg shadow-sm border border-slate-200">
                    <div class="p-6">
                        ...
                        <p class="text-sm text-slate-500 mt-1">3 customers found</p>
                    </div>
                    <div class="table-container">
                        <table class="customer-table w-full text-sm text-left">
                            <thead class="text-xs text-slate-600 uppercase bg-slate-50 border-y border-slate-200">
                                <tr>
                                    <th scope="col" class="px-6 py-3 font-medium">Name</th>
                                    <th scope="col" class="px-6 py-3 font-medium">GSTIN</th>
                            ...
                            <tbody class="text-slate-700">
                                <tr class="border-b border-slate-200 hover:bg-slate-50">
                                    <td class="px-6 py-4 font-medium">RAJEEV KUMAR SANDEEP KUMAR JAIN SARRAF</td>
                                    <td class="px-6 py-4">09ABQCJ6912Z1ZX</td>
                                    <td class="px-6 py-4">Uttar Pradesh (09)</td>
                                    <td class="px-6 py-4">SAHARANPUR</td>
                                    <td class="px-6 py-4 text-right">
                                        <button onclick="editCustomer(1)" class="font-medium text-blue-600 hover:text-blue-800 mr-4">Edit</button>
                                        <button onclick="deleteCustomer(1)" class="font-medium text-red-600 hover:text-red-800">Delete</button>
                                    </td>
                                </tr>
                                <tr class="border-b border-slate-200 hover:bg-slate-50">
                                    <td class="px-6 py-4 font-medium">MOHAN LAL JEWELLERS</td>
                                    <td class="px-6 py-4">07AABCM1234N1ZP</td>
                                    <td class="px-6 py-4">Delhi (07)</td>
                                    <td class="px-6 py-4">Chandni Chowk, Delhi</td>
                                    <td class="px-6 py-4 text-right">
                                        <button onclick="editCustomer(2)" class="font-medium text-blue-600 hover:text-blue-800 mr-4">Edit</button>
                                        <button onclick="deleteCustomer(2)" class="font-medium text-red-600 hover:text-red-800">Delete</button>
                                    </td>
                                </tr>
                                <tr class="border-b border-slate-200 hover:bg-slate-50">
                                    <td class="px-6 py-4 font-medium">DIAMOND GEMS</td>
                                    <td class="px-6 py-4">27AABCD1234N1ZR</td>
                                    <td class="px-6 py-4">Maharashtra (27)</td>
                                    <td class="px-6 py-4">Mumbai</td>
                                    <td class="px-6 py-4 text-right">
                                        <button onclick="editCustomer(3)" class="font-medium text-blue-600 hover:text-blue-800 mr-4">Edit</button>
                                        <button onclick="deleteCustomer(3)" class="font-medium text-red-600 hover:text-red-800">Delete</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
